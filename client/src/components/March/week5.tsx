	...
	return (
		<>
			...
			<div className='row h-100'>
				<div className='col-lg-3 col-md-6 d-flex h-50 '>
					<WeekBox
						day='monday'
				...
				<div className='col-lg-3 col-md-6 d-flex justify-content-center bluerose-img'></div>

				<div className='w-100 d-none d-md-block mt-7'></div>
				<div className='col-lg-3 col-md-6 d-flex violet-img'></div>
				<div className='col-lg-3 col-md-6 d-flex h-50'>
					<WeekBox
						day='thursday'
