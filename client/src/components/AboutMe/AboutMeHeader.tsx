...
import Slide2 from "../../assets/about/about-us-slide-2-940-1000.59395e8ea1ab620b8bc6.jpg";
...
const Main = () => {
	useEffect(() => {
		...
		return () => {
			jarallax(document.querySelectorAll(".jarallax-img"), "destroy");
		};
	}, []);
	return (
		<>
			<div className='py-160 min-vh-100 d-flex align-items-center position-relative lines-style-3'>
				...
				<div className='background bg-dark'>
					<div className='background-image jarallax'>
